...
@section('pageTitle','إدارة جهات الدخل')
@section('headerCSS')
...
@section('navigation3','إدارة جهات الدخل')
@section('navigation1_link','/admin/home')
@section('navigation3_link','/admin/incomeTypes')
            ...
            <div class="kt-portlet__body">
                ...
                <table class="table table-bordered table-hover" id="table">
                    ...
                    <tr class="text-center">
                        <th class="big-col">#</th>
                        <th class="big-col">اسم جهة الدخل بالعربي</th>
                        <th class="big-col">اسم جهة الدخل بالتركي</th>
                        <th width="15%">العمليات</th>
                    </tr>
                    </thead>
                    <tbody>
                    @php $i = 1 @endphp
                    @foreach($incomeTypes->sortByDesc('created_at') as $incomeType)
                        <tr>
                            <td width="10%"> {{ $i }} </td>
                            <td> {{ $incomeType->name }} </td>
                            <td> {{ !is_null($incomeType->name_tr) ? $incomeType->name_tr : '-' }} </td>
                            <td>
                                <div class="dropdown dropdown-inline">
                                    ...
                                    <div class="dropdown-menu dropdown-menu-right">
                                        <a class="dropdown-item Confirm"
                                           href="{{ url('admin/incomeTypes/delete/'.$incomeType->id) }}"><i
                                                    class="fa fa-trash"></i>حذف</a>
                                        <a class="dropdown-item"
                                           href="{{ url('admin/incomeTypes/'.$incomeType->id .'/edit') }}"><i
