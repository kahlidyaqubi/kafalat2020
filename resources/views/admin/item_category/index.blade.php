...
@section('pageTitle','إدارة الأصناف')
@section('headerCSS')
@endsection

@section('navigation1','الرئيسية')
@section('navigation3','إدارة الأصناف')
@section('navigation1_link','/admin/home')
@section('navigation3_link','/admin/item_categories')
                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-4 col-md-6 col-sm-12">
                            <div class="form-group">
                                <label class="col-form-label col-lg-12">بحث من خلال اسم الصنف</label>
                                <div style="width: 95%;">
                            ...
                            <span
                                ...
                                <label>
                                    <input class="cbActive" type="checkbox"
                                           ...
                                           title="لا تملك صلاحية اعتماد صنف"
                                           value="{{$item->id}}"
                            @endif>
                                    <span></span>
                                </label>
                                ...
                                <td>
                                    ...
                                    <div class="dropdown dropdown-inline">
                                        ...
                                        <div class="dropdown-menu dropdown-menu-right">
                                            <a class="dropdown-item" href="/admin/item_categories/{{$item->id}}/edit"><i
                                                        class="fa fa-pen"></i>
                                                تعديل
                                            </a>
                                            <a class="dropdown-item" href="/admin/item_types?item_category_ids[]={{$item->id}}"><i
                                                        class="fa fa-pen"></i>
                                                الوحدات
                                            </a>
                                            <a class="dropdown-item Confirm"
                                               href="/admin/item_categories/delete/{{$item->id}}">
    ...
    <script>
        $(function () {
            $(".cbActive").change(function () {
                ...
                $.ajax({
                    url: "/admin/item_categories/approve/" + id,
