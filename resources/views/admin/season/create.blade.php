...
@section('navigation3','إضافة موسم')
@section('navigation1_link','/admin/home')
@section('navigation2_link','/admin/seasons')
@section('navigation3_link','/admin/seasons/create')
@section('content')
    ...
    <div class="col-lg-12 col-xl-12">
        ...
        <div class="kt-portlet kt-portlet--mobile">
            ...
            <form class="kt-portlet__body" method="post" action="/admin/seasons">
            @csrf
            <!-- Start Row -->
                <div class="row">
                    <!-- Start col -->
                        ...
                        <div class="form-group row">
                            <label class="col-form-label col-lg-12">تاريخ الموسم
                                ...
                                <input  style="width: 95%;" autocomplete="off" required readonly="readonly" class="form-control datepicker" name="start_date" type="text"
                                   value="{{old('start_date')?date('Y-m', strtotime(old('start_date'))):""}}">
                        </div>
                    </div>
                    <div class="col-lg-6 col-md-6 col-sm-12">
                        <div class="form-group row">
