...
@section('navigation2','إدارة عقارات')
@section('navigation3','إضافة عقار')
@section('navigation1_link','/admin/home')
@section('navigation2_link','/admin/immovables')
@section('navigation3_link','/admin/immovables/create')
@section('content')
