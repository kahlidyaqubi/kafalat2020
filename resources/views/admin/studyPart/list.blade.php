...
@section('pageTitle','إدارة جهات الدراسة')
@section('headerCSS')
...
@section('navigation3','إدارة جهات الدراسة')
@section('navigation1_link','/admin/home')
@section('navigation3_link','/admin/studyParts')
            ...
            <div class="kt-portlet__body">
                ...
                <table class="table table-bordered table-hover" id="table">
                    ...
                    <tr class="text-center">
                        <th class="big-col">#</th>
                        <th class="big-col">جهة الدراسة</th>
                        <th width="15%">العمليات</th>
                    </tr>
                    </thead>
                    <tbody>
                    @php $i = 1 @endphp
                    @foreach($studyParts->sortByDesc('created_at') as $studyPart)
                        <tr>
                            <td width="10%"> {{ $i }} </td>
                            <td> {{ $studyPart->name }} </td>
                            <td>
                                <div class="dropdown dropdown-inline">
                                    ...
                                    <div class="dropdown-menu dropdown-menu-right">
                                        <a class="dropdown-item Confirm"
                                           href="{{ url('admin/studyParts/delete/'.$studyPart->id) }}"><i
                                                    class="fa fa-trash"></i>حذف</a>
                                        <a class="dropdown-item"
                                           href="{{ url('admin/studyParts/'.$studyPart->id .'/edit') }}"><i
