...
@section('pageTitle','إدارة أنواع العمل')
@section('headerCSS')
...
@section('navigation3','إدارة أنواع العمل')
@section('navigation1_link','/admin/home')
@section('navigation3_link','/admin/jobTypes')
            ...
            <div class="kt-portlet__body">
                ...
                <table class="table table-bordered table-hover" id="table">
                    ...
                    <tr class="text-center">
                        <th class="big-col">#</th>
                        <th class="big-col"> نوع العمل بالعربي</th>
                        <th class="big-col">اسم نوع العمل بالتركي</th>
                        <th width="15%">العمليات</th>
                    </tr>
                    </thead>
                    <tbody>
                    @php $i = 1 @endphp
                    @foreach($jobTypes->sortByDesc('created_at') as $jobType)
                        <tr>
                            <td width="10%"> {{ $i }} </td>
                            <td> {{ $jobType->name }} </td>
                            <td> {{ !is_null($jobType->name_tr) ? $jobType->name_tr : '-' }} </td>
                            <td>
                                <div class="dropdown dropdown-inline">
                                    ...
                                    <div class="dropdown-menu dropdown-menu-right">
                                        <a class="dropdown-item Confirm"
                                           href="{{ url('admin/jobTypes/delete/'.$jobType->id) }}"><i
                                                    class="fa fa-trash"></i>حذف</a>
                                        <a class="dropdown-item"
                                           href="{{ url('admin/jobTypes/'.$jobType->id .'/edit') }}"><i
