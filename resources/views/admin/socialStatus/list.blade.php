...
@section('pageTitle','إدارة الحالات الاجتماعية')
@section('headerCSS')
...
@section('navigation3','إدارة الحالات الاجتماعية')
@section('navigation1_link','/admin/home')
@section('navigation3_link','/admin/socialStatuses')
            ...
            <div class="kt-portlet__body">
                ...
                <table class="table table-bordered table-hover" id="table">
                    ...
                    <tr class="text-center">
                        <th class="big-col">#</th>
                        <th class="big-col"> الحالة الاجتماعية بالعربي</th>
                        <th class="big-col">
                            الحالة الاجتماعية
                            بالتركي
                        </th>
                    ...
                    @foreach($socialStatuses as $socialStatus)
                        <tr>
                            ...
                            <td> {{ !is_null($socialStatus->name_tr) ? $socialStatus->name_tr : '-' }} </td>
                                ...
                                <div class="dropdown dropdown-inline">
                                    ...
                                    <div class="dropdown-menu dropdown-menu-right">
                                        <a class="dropdown-item Confirm"
                                           href="{{ url('admin/socialStatuses/delete/'.$socialStatus->id) }}"><i
                                                    class="fa fa-trash"></i>حذف</a>
                                        <a class="dropdown-item"
                                           href="{{ url('admin/socialStatuses/'.$socialStatus->id .'/edit') }}"><i
