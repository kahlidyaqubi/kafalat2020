...
@section('pageTitle','إدارة المستويات التعليمية')
@section('headerCSS')
...
@section('navigation3','إدارة المستويات التعليمية')
@section('navigation1_link','/admin/home')
@section('navigation3_link','/admin/qualificationLevels')
            ...
            <div class="kt-portlet__body">
                ...
                <table class="table table-bordered table-hover" id="table">
                    ...
                    <tr class="text-center">
                        <th class="big-col">#</th>
                        <th class="big-col">المستوى التعليمي</th>
                        <th width="15%">العمليات</th>
                    </tr>
                    </thead>
                    <tbody>
                    @php $i = 1 @endphp
                    @foreach($qualificationLevels->sortByDesc('created_at') as $qualificationLevel)
                        <tr>
                            <td width="10%"> {{ $i }} </td>
                                ...
                                <div class="dropdown dropdown-inline">
                                    ...
                                    <div class="dropdown-menu dropdown-menu-right">
                                        <a class="dropdown-item Confirm"
                                           href="{{ url('admin/qualificationLevels/delete/'.$qualificationLevel->id) }}"><i
                                                    class="fa fa-trash"></i>حذف</a>
                                        <a class="dropdown-item"
                                           href="{{ url('admin/qualificationLevels/'.$qualificationLevel->id .'/edit') }}"><i
