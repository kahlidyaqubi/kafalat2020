...
@section('pageTitle','إدارة الأقسام')
@section('headerCSS')
@endsection

@section('navigation1','الرئيسية')
@section('navigation3','إدارة الأقسام')
@section('navigation1_link','/admin/home')
@section('navigation3_link','/admin/departments')
                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-4 col-md-6 col-sm-12">
                            <div class="form-group">
                                <label class="col-form-label col-lg-12">بحث من خلال اسم القسم</label>
                                <div style="width: 95%;">
                            ...
                            <span
                                ...
                                <label>
                                    <input class="cbActive" type="checkbox"
                                           ...
                                           title="لا تملك صلاحية اعتماد قسم"
                                           value="{{$item->id}}"
                            @endif>
                                    <span></span>
                                </label>
                                ...
                                <td>
                                    ...
                                    <div class="dropdown dropdown-inline">
                                        ...
                                        <div class="dropdown-menu dropdown-menu-right">
                                            <a class="dropdown-item" href="/admin/departments/{{$item->id}}/edit"><i
                                                        class="fa fa-pen"></i>
                                                تعديل
                                            </a>
                                            <a class="dropdown-item Confirm"
                                               href="/admin/departments/delete/{{$item->id}}">
    ...
    <script>
        $(function () {
            $(".cbActive").change(function () {
                ...
                $.ajax({
                    url: "/admin/departments/approve/" + id,
