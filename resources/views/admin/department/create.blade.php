...
@section('pageTitle','إضافة قسم')
@section('headerCSS')
@endsection

@section('navigation1','الرئيسية')
@section('navigation2','إدارة الأقسام')
@section('navigation3','إضافة قسم')
@section('navigation1_link','/admin/home')
@section('navigation2_link','/admin/departments')
@section('navigation3_link','/admin/departments/create')
@section('content')
    ...
    <div class="col-lg-12 col-xl-12">
        ...
        <div class="kt-portlet kt-portlet--mobile">
            ...
            <form class="kt-portlet__body" method="post" action="/admin/departments">
            @csrf
            <!-- Start Row -->
                <div class="row">
                    <!-- Start col -->
