...
@section('pageTitle','إدارة أسباب المساعدات')
@section('headerCSS')
@endsection

@section('navigation1','الرئيسية')
@section('navigation3','إدارة أسباب المساعدات')
@section('navigation1_link','/admin/home')
@section('navigation3_link','/admin/coupon_reasons')
                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-4 col-md-6 col-sm-12">
                            <div class="form-group">
                                <label class="col-form-label col-lg-12">بحث من خلال اسم سبب المساعدة</label>
                                <div style="width: 95%;">
                ...
                <div class="table-responsive">
                    ...
                    <table class="table table-bordered table-hover ">
                        ...
                        <tr class="text-center">
                            ...
                            <th style="width: 20%;">اسم السبب مساعدة
                            </th>
                        ...
                        <tbody>
                        @foreach($coupon_reasons as $item)
                            <tr class="text-center">
                                <td>
                                    {{ $item->id }}</td>
                                <td>{{$item->name}}</td>
                            ...
                            <span
                                ...
                                <label>
                                    <input class="cbActive" type="checkbox"
                                           @if(auth()->user()->hasPermissionTo(163))
                                           {{$item->status?"checked":" "}} value="{{$item->id}}"
                                           @else
                                           {{$item->status?"checked":" "}}disabled
                                           title="لا تملك صلاحية اعتماد سبب مساعدة"
                                           value="{{$item->id}}"
                            @endif>
                                    <span></span>
                                </label>
                                ...
                                <td>
                                    ...
                                    <div class="dropdown dropdown-inline">
                                        ...
                                        <div class="dropdown-menu dropdown-menu-right">
                                            <a class="dropdown-item" href="/admin/coupon_reasons/{{$item->id}}/edit"><i
                                                        class="fa fa-pen"></i>
                                                تعديل
                                            </a>
                                            <a class="dropdown-item Confirm"
                                               href="/admin/coupon_reasons/delete/{{$item->id}}">
    ...
    <script>
        $(function () {
            $(".cbActive").change(function () {
                ...
                $.ajax({
                    url: "/admin/coupon_reasons/approve/" + id,
