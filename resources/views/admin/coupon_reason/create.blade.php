...
@section('pageTitle','إضافة سبب مساعدة')
@section('headerCSS')
@endsection

@section('navigation1','الرئيسية')
@section('navigation2','إدارة الأسباب المساعدات')
@section('navigation3','إضافة سبب مساعدة')
@section('navigation1_link','/admin/home')
@section('navigation2_link','/admin/coupon_reasons')
@section('navigation3_link','/admin/coupon_reasons/create')
@section('content')
    ...
    <div class="col-lg-12 col-xl-12">
        ...
        <div class="kt-portlet kt-portlet--mobile">
            ...
            <form class="kt-portlet__body" method="post" action="/admin/coupon_reasons">
            @csrf
            <!-- Start Row -->
                <div class="row">
                    <!-- Start col -->
