...
@section('pageTitle','إدارة الوحدات')
@section('headerCSS')
@endsection

@section('navigation1','الرئيسية')
@section('navigation3','إدارة الوحدات')
@section('navigation1_link','/admin/home')
@section('navigation3_link','/admin/item_types')
                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-4 col-md-6 col-sm-12">
                            <div class="form-group">
                                <label class="col-form-label col-lg-12">بحث من خلال اسم الوحدة</label>
                                <div style="width: 95%;">
                        ...
                        <div class="col-lg-4 col-md-6 col-sm-12">
                            <div class="form-group">
                                <div style="width: 95%;">
                                    <label class="col-form-label col-lg-12">أصناف الوحدات </label>
                                    <select class="form-control kt-select2 select2-multi"
                                            id="item_category_ids" name="item_category_ids[]"
                                            multiple="multiple">
                                        <option value=" "> الصنف</option>
                                        @foreach($item_categories as $item_category)
                                            <option value="{{$item_category->id}}"
                                                    @if(in_array($item_category->id, $item_category_ids)) selected @endif>{{$item_category->name}}</option>
                                        @endforeach
                                    </select>
                                </div>
                            </div>
                ...
                <div class="table-responsive">
                    ...
                    <table class="table table-bordered table-hover ">
                        ...
                        <tr class="text-center">
                            ...
                            <th style="width: 20%;">اسم الوحدة
                            </th>
                            <th style="width: 20%;">الصنف
                            </th>
                            ...
                            <span
                                ...
                                <label>
                                    <input class="cbActive" type="checkbox"
                                           ...
                                           title="لا تملك صلاحية اعتماد وحدة"
                                           value="{{$item->id}}"
                            @endif>
                                    <span></span>
                                </label>
                                ...
                                <td>
                                    ...
                                    <div class="dropdown dropdown-inline">
                                        ...
                                        <div class="dropdown-menu dropdown-menu-right">
                                            <a class="dropdown-item" href="/admin/item_types/{{$item->id}}/edit"><i
                                                        class="fa fa-pen"></i>
                                                تعديل
                                            </a>
                                            <a class="dropdown-item Confirm"
                                               href="/admin/item_types/delete/{{$item->id}}">
    ...
    <script>
        $(function () {
            $(".cbActive").change(function () {
                ...
                $.ajax({
                    url: "/admin/item_types/approve/" + id,
