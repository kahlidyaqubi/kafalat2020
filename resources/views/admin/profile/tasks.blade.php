...
@section('navigation2','البروفايل')
@section('navigation3','مهام على المستخدم')
@section('navigation1_link','/admin/home')
@section('navigation2_link','/admin/profile')
@section('navigation3_link','/admin/profile/tasks/')
@section('content')
            ...
            <div class="kt-portlet__head">
                <div class="kt-portlet__head-label">
                    ...
                    <h3 class="kt-portlet__head-title">
                        مهام على المستخدم {{$user->full_name}}
                    </h3>
                </div>
            </div>
                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-4 col-md-6 col-sm-12">
                            <div class="form-group">
                                <label class="col-form-label col-lg-12">بحث من خلال عنوان المهمة</label>
                                <div style="width: 95%;">
                            ...
                            <div class="form-group">
                                <div style="width: 95%;">
                                    ...
                                    <select class="form-control kt-select2 select2-multi"
                                        ...
                                        <option disabled value="1"> تمت</option>
                                        <option disabled value="0"> لم تتم</option>
                                    </select>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="col-lg-4 col-md-6 col-sm-12">
                            <div class="form-group">
                                <div style="width: 95%;">
                                    ...
                                    <select class="form-control kt-select2 select2-multi"
                                            id="done" name="done">
                                        <option disabled selected> القبول</option>
                                        <option disabled value="1"> مقبولة</option>
                                        <option disabled value="0"> غير مقبولة</option>
                                    </select>
                                </div>
                            </div>
                        </div>
                        ...
                        <!-- End col -->
                        <!-- End col -->
                        <div style="display: none" class="col-lg-4 col-md-6 col-sm-12 type3">
                            <div class="form-group">
                        ...
                        <div class="col-lg-4 col-md-6 col-sm-12">
                            <div class="form-group">
                                <div style="width: 95%;" id="admin_ids">
                        ...
                        <div class="col-lg-4 col-md-6 col-sm-12">
                            <div class="form-group">
                                <div style="width: 95%;" id="user_ids">
                        ...
                        <!-- End col -->
                        <div class="col-lg-4 col-md-6 col-sm-12" id="type1" style="display: none">
                            <div class="form-group">
                            ...
                            <span
                                ...
                                <label>
                                    <input class="cbActive2" type="checkbox"
                                           @if(auth()->user()->hasPermissionTo(231) && auth()->user()->id == $item->admin_id)
