...
@section('navigation2','إدارة الأحياء')
@section('navigation3','تعديل حي')
@section('navigation1_link','/admin/home')
@section('navigation2_link','/admin/neighborhoods')
@section('navigation3_link','/admin/neighborhoods/'.$neighborhood->id.'/edit')
@section('content')
    <div class="col-lg-12 col-xl-12">
        ...
        <div class="kt-portlet kt-portlet--mobile">
            ...
            <div class="kt-portlet__body">
                <form method="post"
                      action="{{ url('admin/neighborhoods',$neighborhood->id) }}">
                ...
                <!-- Start Row -->
                    <div class="row">
                        ...
                        <div class="col-md-6">
                            <div class="form-group row">
                                <label class="col-form-label col-lg-12">اسم الحي بالعربي</label>
                                <div style="width: 95%;">
                                    <input type="text" class="form-control arabic" id="name" name="name"
                                           value="{{ $neighborhood->name }}" placeholder="الاسم بالعربي">
                                </div>
                            </div>
                        </div>
                        <!-- End col -->
                        ...
                        <div class="col-md-6">
                            <div class="form-group row">
                                <label class="col-form-label col-lg-12">اسم الحي بالتركي</label>
                                <div style="width: 95%;">
                                    <input type="text" class="form-control turkey" id="name_tr" name="name_tr"
                                           value="{{ $neighborhood->name_tr }}"
