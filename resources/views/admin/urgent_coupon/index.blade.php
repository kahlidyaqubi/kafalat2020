...
@section('pageTitle','إدارة المساعدات الطارئة')
@section('headerCSS')
    ...
    <!--begin::Portlet-->
        <div class="kt-portlet kt-portlet--mobile">
            ...
            <div class="kt-portlet__body">
                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-4 col-md-6 col-sm-12 ">
                            <div class="form-group row">
                                <label class="col-form-label col-lg-12">تاريخ المساعدة من</label>
                                <div style="width: 95%;">
                                    <input class="form-control datepicker-custome" placeholder="yyyy-mm-dd" readonly="readonly" name="from_his_date"
                                           type="text"
                                           value="{{$from_his_date}}">
                                </div>
                            </div>
                        ...
                        <div class="col-lg-4 col-md-6 col-sm-12 ">
                            <div class="form-group row">
                                <label class="col-form-label col-lg-12">تاريخ المساعدة إلى</label>
                                <div style="width: 95%;">
                                    <input class="form-control datepicker-custome" placeholder="yyyy-mm-dd" readonly="readonly" name="to_his_date" type="text"
                                           value="{{$to_his_date}}">
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="col-lg-4 col-md-6 col-sm-12">
                            <div class="form-group">
                                <div style="width: 95%;">
                                    <label class="col-form-label col-lg-12">التمويل</label>
                                    <select class="form-control kt-select2 select2-multi"
                                            id="funder_type" name="funder_type">
                                        <option value=" " selected> التمويل</option>
                                        <option value="1" @if($funder_type == 1)selected @endif> ممولة</option>
                                        <option value="0" @if($funder_type === '0')selected @endif>غير ممولة
                                        </option>
                                    </select>
                                </div>
                            </div>
                        ...
                        <div class="col-lg-4 col-md-6 col-sm-12">
                            <div class="form-group">
                                <div style="width: 95%;" id="families_yes">
                                    <label class="col-form-label col-lg-12">المكفولين
                                    </label>
                        ...
                        <div class="col-lg-4 col-md-6 col-sm-12">
                            <div class="form-group">
                                <div style="width: 95%;" id="families_no">
                        ...
                        <div class="col-lg-4 col-md-6 col-sm-12">
                            <div class="form-group">
                                <div style="width: 95%;" id="sponsor_ids">
                                    ...
                                    <select id='selUser2' name="sponsors_ids[]" style='width: 200px;'
                                            multiple>
                                        <option value='  '>- اختر كافلا -</option>
                                        @if($sponsors_ids)
                        ...
                        <!-- End col export-->
                @if(auth()->user()->hasPermissionTo('create urgent_coupons'))

                        <div class="col-md-3">
                            <div class="form-group">
                                <a class="btn btn-outline-success  col" href="/admin/urgent_coupons/import_urgent_coupon">استيراد اكسترا ياردم</a>
                            </div>
                        </div>
                        <div class="col-md-3">
                            <div class="form-group">
                                <a class="btn btn-outline-success col" href="/admin/urgent_coupons/import_urgent_coupon_extra">استيراد مساعدات طارئة</a>
                            </div>                        
                        </div>
                @endif
                       ...
                       <!-- Satrt Button SMS -->
                         <div class="col-md-2">
                            <div class="form-group ">
                                ...
                                <a type="submit" class="btn btn-outline-success  col" formaction="/admin/urgent_coupons/sendSMS" name="theaction" onclick="sms_all()">ابلاغ رسائل للمحدد</a>
                            </div>
                        </div>
                        <!-- End col -->
                    </div>
                ...
                <!--    <div class="row mb-2">-->
                <!--        <div class="col-md-6">-->
                <!--            <a class="btn btn-success  col" href="/admin/urgent_coupons/import_urgent_coupon">استيراد-->
                <!--                اكسترا ياردم</a>-->
                <!--        </div>-->
                <!--        <div class="col-md-6">-->
                <!--            <a class="btn btn-success  col" href="/admin/urgent_coupons/import_urgent_coupon_extra">استيراد-->
                <!--                مساعدات طارئة</a>-->
                <!--        </div>-->
                <!--    </div>-->
                <!--@endif-->
                <!--<div class="row">-->
                <!--    <form action="/admin/urgent_coupons/sendSMS">-->
                <!--        <input type="hidden" name="the_ids" id="myIds1">-->
                <!--        <div class="input-field col s12 m3">-->
                <!--            <a class="btn btn-success  col" name="theaction" onclick="sms_all()">ابلاغ رسائل للمحدد-->
                <!--            </a>-->
                <!--        </div>-->
                <!--    </form>-->
                <!--</div>-->
                    ...
                    <table class="table table-bordered table-hover ">
                        ...
                        <tr class="text-center">
                            ...
                            @if(collect($coulmn)->contains('his_date'))
                                <th style="width: 15%">تاريخ المساعدة
                                </th>@endif
                            @if(collect($coulmn)->contains('sponsor'))
                                <th style="width: 15%;">الكافل
                                </th>@endif
                        ...
                        @foreach($urgent_coupons as $item)
                            <tr class="text-center">
                                ...
                                @if(collect($coulmn)->contains('family_or_institution'))
                                    <td>
                                        {{$item->family_id && $item->family ? $item->family->person->full_name : $item->institution->name}}</td>@endif
                                @if(collect($coulmn)->contains('coupon_type'))
                                    <td>{{$item->family_id? "للأفراد" : "للمؤسسات"}}</td>@endif
                                @if(collect($coulmn)->contains('his_date'))
                                    <td>
                                        {{$item->his_date?date('d-m-Y', strtotime($item->his_date)):""}}</td>@endif
                                @if(collect($coulmn)->contains('sponsor'))
                                        ...
                                        <div class="dropdown dropdown-inline">
                                            ...
                                            <div class="dropdown-menu dropdown-menu-right">
                                                <a class="dropdown-item Confirm"
                                                   href="/admin/urgent_coupons/delete/{{$item->id}}">
                                                    <i class="fa fa-shopping-bag"></i>
                                                    حذف</a>
                                                <a class="dropdown-item"
                                                   href="/admin/urgent_coupons/{{$item->id}}/edit">
                                                    <i class="fa fa-shopping-bag"></i>
                                                    تعديل</a>
                                            </div>
                                        </div>
    ...
    <script>
        $(function () {
            ...
            $(".cbActive3").click(function () {
                ...
                if ($(this).val() == "all") {
                    $.ajax({
                        url: "/admin/urgent_coupons/sendSMS",
                        data: {
                            _token: '{{ csrf_token() }}',
                            massage: $('#massage').val(),
                            the_type: 'json',
    ...
    <script>
        $(function () {
            $(".cbActive").change(function () {
                ...
                mythis.disabled = true;
                $.ajax({
                    url: "/admin/urgent_coupons/delivery",
                    data: {
                        _token: '{{ csrf_token() }}',
                        the_type: 'json',
                        the_ids: id,
    ...
    <script>
        $(function () {
            ...
            $(".cbActive2").click(function () {
                ...
                console.log("oka" + id);
                $.ajax({
                    url: "/admin/urgent_coupons/approve",
                    data: {
                        _token: '{{ csrf_token() }}',
