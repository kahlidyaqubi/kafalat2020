...
@section('navigation2','إضافة مساعدة طارئة')
@section('navigation3','اختيار المستلم')
@section('navigation1_link','/admin/home')
@section('navigation2_link','/admin/urgent_coupons/')
@section('navigation3_link','/admin/urgent_coupons/searctoaddcoupon')
@section('content')
    ...
    <div class="col-lg-12 col-xl-12">
        ...
        <div class="kt-portlet kt-portlet--mobile">
            ...
            <form class="kt-portlet__body" action="/admin/urgent_coupons/editorcreat">
            @csrf
            <!-- Start Row -->
                <div class="row">
                    <!-- Start col -->
