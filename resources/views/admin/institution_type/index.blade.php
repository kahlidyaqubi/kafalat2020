...
@section('pageTitle','إدارة أنواع الجمعيات')
@section('headerCSS')
@endsection

@section('navigation1','الرئيسية')
@section('navigation3','إدارة الأنواع الجمعيات')
@section('navigation1_link','/admin/home')
@section('navigation3_link','/admin/institution_types')
                ...
                <div class="table-responsive">
                    ...
                    <table class="table table-bordered table-hover ">
                        ...
                        <tr class="text-center">
                            ...
                            <th style="width: 20%;">اسم نوع الجمعية
                            </th>
                            ...
                            <span
                                ...
                                <label>
                                    <input class="cbActive" type="checkbox"
                                           ...
                                           title="لا تملك صلاحية اعتماد نوع الجمعية"
                                           value="{{$item->id}}"
                            @endif>
                                    <span></span>
                                </label>
                                ...
                                <td>
                                    ...
                                    <div class="dropdown dropdown-inline">
                                        ...
                                        <div class="dropdown-menu dropdown-menu-right">
                                            <a class="dropdown-item" href="/admin/institution_types/{{$item->id}}/edit"><i
                                                        class="fa fa-pen"></i>
                                                تعديل
                                            </a>
                                            <a class="dropdown-item Confirm"
                                               href="/admin/institution_types/delete/{{$item->id}}">
    ...
    <script>
        $(function () {
            $(".cbActive").change(function () {
                ...
                $.ajax({
                    url: "/admin/institution_types/approve/" + id,
