...
@section('pageTitle','إدارة أنواع الدراسة')
@section('headerCSS')
...
@section('navigation3','إدارة أنواع الدراسة')
@section('navigation1_link','/admin/home')
@section('navigation3_link','/admin/studyTypes')
            ...
            <div class="kt-portlet__body">
                ...
                <table class="table table-bordered table-hover" id="table">
                    ...
                    <tr class="text-center">
                        <th class="big-col">#</th>
                        <th class="big-col">نوع الدراسة</th>
                        <th width="15%">العمليات</th>
                    </tr>
                    </thead>
                    <tbody>
                    @php $i = 1 @endphp
                    @foreach($studyTypes->sortByDesc('created_at') as $studyType)
                        <tr>
                            <td width="10%"> {{ $i }} </td>
                                ...
                                <div class="dropdown dropdown-inline">
                                    ...
                                    <div class="dropdown-menu dropdown-menu-right">
                                        <a class="dropdown-item Confirm"
                                           href="{{ url('admin/studyTypes/delete/'.$studyType->id) }}"><i
                                                    class="fa fa-trash"></i>حذف</a>
                                        <a class="dropdown-item"
                                           href="{{ url('admin/studyTypes/'.$studyType->id .'/edit') }}"><i
