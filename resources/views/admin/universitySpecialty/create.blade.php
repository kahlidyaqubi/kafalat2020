...
@section('pageTitle','إضافة تخصص جامعي')
@section('headerCSS')
...
@section('navigation3','إضافة تخصص جامعي')
@section('navigation1_link','/admin/home')
@section('navigation2_link','/admin/universitySpecialties')
@section('navigation3_link','/admin/universitySpecialties/create')
@section('content')
    <div class="col-lg-12 col-xl-12">
        ...
        <div class="kt-portlet kt-portlet--mobile">
            ...
            <div class="kt-portlet__body">
                <form method="post"
                      action="{{ url('admin/universitySpecialties') }}">
                @csrf
                <!-- Start Row -->
                    <div class="row">
                        <!-- Start col -->
