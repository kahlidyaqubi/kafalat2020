...
@section('pageTitle','كشوفات الكافل')
@section('headerCSS')
...
@section('navigation3','كشوفات الكافل')
@section('navigation1_link','/admin/home')
@section('navigation2_link','/admin/sponsors')
@section('navigation3_link','/admin/sponsors/expenseLog/'.$sponsor->id)
@section('content')
    <style>
