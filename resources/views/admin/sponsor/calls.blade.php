...
@section('pageTitle','اتصالات الكافل')
@section('headerCSS')
...
@section('navigation3','اتصالات الكافل')
@section('navigation1_link','/admin/home')
@section('navigation2_link','/admin/sponsors')
@section('navigation3_link','/admin/sponsors/callLog/'.$sponsor->id.'')
@section('content')
                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-4 col-md-6 col-sm-12 type3">
                            <div class="form-group">
                                <div style="width: 99%;" id="family_ids">
                        ...
                        <div class="col-lg-4 col-md-6 col-sm-12">
                            <div class="form-group">
                                <div style="width: 99%;" id="sponsor_ids">
                        ...
                        <div class="col-lg-4 col-md-6 col-sm-12">
                            <div class="form-group">
                                <label class="col-form-label col-lg-12">سبب الاتصال</label>
                                <div style="width: 99%;">
                    ...
                    <table class="table table-bordered table-hover ">
                        ...
                        @foreach($calls as $item)
                            <tr class="text-center">
                                ...
                                @if(collect($coulmn)->contains('sponsor'))
                                    <td>{{$item->sponsor->name}}</td>@endif
                                @if(collect($coulmn)->contains('reason'))
                                    <td>{{$item->reason}}</td>@endif
                                @if(collect($coulmn)->contains('status'))
                                    <td>{{$item->status?"ناجحة":"فاشلة"}}</td>
                                    </td>@endif
                                @if(collect($coulmn)->contains('admin'))
