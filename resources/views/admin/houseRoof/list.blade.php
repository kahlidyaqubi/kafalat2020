...
@section('pageTitle','إدارة أنواع السكن')
@section('headerCSS')
...
@section('navigation3','إدارة أنواع السكن')
@section('navigation1_link','/admin/home')
@section('navigation3_link','/admin/houseRoofs')
            ...
            <div class="kt-portlet__body">
                ...
                <table class="table table-bordered table-hover" id="table">
                    ...
                    <tr class="text-center">
                        <th class="big-col">#</th>
                        <th class="big-col"> نوع السكن بالعربي</th>
                        <th class="big-col"> نوع السكن بالتركي</th>
                        <th width="15%">العمليات</th>
                    </tr>
                    </thead>
                    <tbody>
                    @php $i = 1 @endphp
                    @foreach($houseRoofs->sortByDesc('created_at') as $houseRoof)
                        <tr>
                            <td width="10%"> {{ $i }} </td>
                            <td> {{ $houseRoof->name }} </td>
                            <td> {{ !is_null($houseRoof->name_tr) ? $houseRoof->name_tr :'-' }} </td>
                            <td>
                                <div class="dropdown dropdown-inline">
                                    ...
                                    <div class="dropdown-menu dropdown-menu-right">
                                        ...
                                        <a class="dropdown-item"
                                           href="{{ url('admin/houseRoofs/'.$houseRoof->id .'/edit') }}"><i
                                                    class="fa fa-edit"></i>تعديل</a>
                                        <a class="dropdown-item Confirm"
                                           href="{{ url('admin/houseRoofs/delete/'.$houseRoof->id) }}"><i
