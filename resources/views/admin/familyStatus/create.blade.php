...
@section('pageTitle','إضافة وضع الحالة')
@section('headerCSS')
@endsection
@section('headerJS')@endsection
@section('navigation1','الرئيسية')
@section('navigation2','إدارة أوضاع الحالات')
@section('navigation3','إضافة وضع الحالة')
@section('navigation1_link','/admin/home')
@section('navigation2_link','/admin/familyStatuses')
@section('navigation3_link','/admin/familyStatuses/create')
@section('content')
    <div class="col-lg-12 col-xl-12">
        ...
        <div class="kt-portlet kt-portlet--mobile">
            ...
            <div class="kt-portlet__body">
                <form method="post"
                      action="{{ url('admin/familyStatuses') }}">
                @csrf
                <!-- Start Row -->
                    <div class="row">
                        <!-- Start col -->
                        <div class="col-md-6">
                            <div class="form-group row">
                                <label class="col-form-label col-lg-12">اسم وضع الحالة بالعربي</label>
                                <div style="width: 95%;">
                        ...
                        <div class="col-md-6">
                            <div class="form-group row">
                                <label class="col-form-label col-lg-12">اسم وضع الحالة بالتركي</label>
                                <div style="width: 95%;">
