...
@section('pageTitle','إدارة المستويات الجامعية')
@section('headerCSS')
...
@section('navigation3','إدارة المستويات الجامعية')
@section('navigation1_link','/admin/home')
@section('navigation3_link','/admin/studyLevels')
            ...
            <div class="kt-portlet__body">
                ...
                <table class="table table-bordered table-hover" id="table">
                    ...
                    <tr class="text-center">
                        <th class="big-col">#</th>
                        <th class="big-col">المستوى الجامعي</th>
                        <th width="15%">العمليات</th>
                    </tr>
                    </thead>
                    <tbody>
                    @php $i = 1 @endphp
                    @foreach($studyLevels->sortByDesc('created_at') as $studyLevel)
                        <tr>
                            <td width="10%"> {{ $i }} </td>
                                ...
                                <div class="dropdown dropdown-inline">
                                    ...
                                    <div class="dropdown-menu dropdown-menu-right">
                                        <a class="dropdown-item Confirm"
                                           href="{{ url('admin/studyLevels/delete/'.$studyLevel->id) }}"><i
                                                    class="fa fa-trash"></i>حذف</a>
                                        <a class="dropdown-item"
                                           href="{{ url('admin/studyLevels/'.$studyLevel->id .'/edit') }}"><i
