...
@section('pageTitle','إضافة جهة مرشحة')
@section('headerCSS')
...
@section('navigation3','إضافة جهة مرشحة')
@section('navigation1_link','/admin/home')
@section('navigation2_link','/admin/fundedInstitutions')
@section('navigation3_link','/admin/fundedInstitutions/create')
@section('content')
    <div class="col-lg-12 col-xl-12">
        ...
        <div class="kt-portlet kt-portlet--mobile">
            ...
            <div class="kt-portlet__body">
                <form method="post"
                      action="{{ url('admin/fundedInstitutions') }}"
                ...
                <!-- Start Row -->
                    <div class="row">
                            ...
                            <div class="form-group row">
                                ...
                                <div style="width: 95%;">
                                    <select class="form-control kt-select2 select2-multi"
                                        ...
                                        <option value="0"> غير جامعية</option>
                                        <option value="1"> جامعية</option>
                                    </select>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="col-md-6">
                            <div class="form-group row">
                                <label class="col-form-label col-lg-12">الشعار</label>
