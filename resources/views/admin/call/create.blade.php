...
@section('navigation3','إضافة اتصال')
@section('navigation1_link','/admin/home')
@section('navigation2_link','/admin/calls')
@section('navigation3_link','/admin/calls/create')
@section('content')
        ...
        <div class="kt-portlet kt-portlet--mobile">
            ...
            <!-- Start Row -->
                <div class="row">
                    ...
                    <div class="col-lg-6 col-md-6 col-sm-12">
                        <div class="form-group row">
                            <label class="col-form-label col-lg-12">الكافل<span
                                    ...
                                    @if(old('sponsor_id'))
                                        ...
                                        @if($sponsor)
                                            <option value="{{$sponsor->id}}"
                                                    selected>{{$sponsor->name}}{{$sponsor->code}}</option>
                                        @endif
                                    @endif
                                </select>
                            </div>
                                ...
                                <select class="form-control "
                                    ...
                                    @foreach($countries as $country)
                                        <option value="{{$country->code}}" country_id="{{$country->id}}"
                                                @if($country->code == old('code')) selected @endif>{{$country->name." ".$country->code}}</option>
                                    @endforeach
                                </select>
                            </div>
                        </div>
                    ...
                    <div class="col-lg-4 col-md-6 col-sm-12">
                        <div class="form-group row">
                            ...
                            <input class="form-control numbers"
                                   ...
                                   value="{{old('sponsor_mobile')}}" style="width: 95%"
                                   placeholder="-رقم اتصال الكافل-">
                        </div>
                    </div>
                    ...
                    <div class="col-lg-6 col-md-6 col-sm-12 type3">
                        <div class="form-group row">
                            ...
                            <div style="width: 95%;">
                                ...
                                <select id='selUser' required name="family_id" style='width: 200px;'>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="input-group" style="width: 96%;">
                                <input maxlength="10"
                                       ...
                                       name="family_mobile"
                                       id="family_mobile"
                                       value="{{old('family_mobile')}}" class="form-control numbers"
                    ...
                    <div class="col-lg-3 col-md-6 col-sm-12">
                        <div class="form-group row">
                            ...
                            <input class="form-control datepicker-custome" placeholder="yyyy-mm-dd" readonly="readonly" type="text"
                                   name="his_date"
                                   value="{{old('his_date')}}" style="width: 86%" placeholder="-تاريخ الاتصال-">
                        </div>
                    </div>
                    <!-- End col -->
                    <!-- Start col -->
                    ...
                    <div class="col-lg-3 col-md-6 col-sm-12">
                        <div class="form-group row">
                            <label class="col-form-label col-lg-12">نجاح الاتصال<span
                                        style="color:red;">*</span></label>
                    ...
                    <div class="col-lg-6 col-md-6 col-sm-12">
                        <div class="form-group row">
                            ...
                            <input class="form-control " required type="text"
                                   name="reason"
                                   value="{{old('reason')}}" style="width: 96%" placeholder="-سبب الاتصال-">
                        </div>
                    </div>
                    <!-- End col -->
                    <!-- Start col -->
                ...
                <div class="col-12">
                    ...
                    <!--<div id="wating" class="col-12 alert alert-light" style="display: none">-->
                    <!--    <div class="spinner-border text-primary" role="status">-->
                    <!--        <span class="sr-only">Loading...</span>-->
                    <!--    </div>-->
                    <!--    <span class="h5 text-primary">&nbsp;&nbsp; الرجاء الانتظار...</span>-->
                    <!--</div>-->
