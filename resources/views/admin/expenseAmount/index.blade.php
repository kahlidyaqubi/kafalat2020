...
@section('pageTitle','إدارة مبالغ الصرف')
@section('headerCSS')
        ...
        <div class="kt-portlet kt-portlet--mobile">
            ...
            <div class="kt-portlet__body">
                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-4 col-md-6 col-sm-12 ">
                            <div class="form-group row">
                                <label class="col-form-label col-lg-12">تاريخ المبلغ من</label>
                                <div style="width: 95%;">
                        ...
                        <div class="col-lg-4 col-md-6 col-sm-12 ">
                            <div class="form-group row">
                                <label class="col-form-label col-lg-12">تاريخ المبلغ إلى</label>
                                <div style="width: 95%;">
                            ...
                            <div class="form-group">
                                <div style="width: 95%;">
                                    ...
                                    <select class="form-control kt-select2 select2-multi"
                                            id="funded_institution_ids" name="funded_institution_ids[]"
                                            multiple="multiple">
                ...
                <div class="row">
                    ...
                    <form action="/admin/expense_amounts/delete_group">
            ...
            <div class="kt-portlet__body ">
                ...
                <div class="table-responsive">
                    ...
                    <table class="table table-bordered table-hover ">
                        ...
                        <tbody>
                        @foreach($expense_amounts as $item)
                            <tr class="text-center">
                                <td>{{ $item->id }}</td>
                                <td>
                                    <div class="">
                                ...
                                <td>
                                    <div class="dropdown dropdown-inline">
                                        ...
                                        <div class="dropdown-menu dropdown-menu-right">
                                            <a class="dropdown-item" href="/admin/expense_amounts/{{$item->id}}/edit">
                                                <i class="fa fa-shopping-bag"></i>
                                                تعديل</a>
                                            <a class="dropdown-item Confirm"
                                               href="/admin/expense_amounts/delete/{{$item->id}}">
