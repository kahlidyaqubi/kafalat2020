...
@section('pageTitle','إدارة فئات استهداف')
@section('headerCSS')
@endsection

@section('navigation1','الرئيسية')
@section('navigation3','إدارة فئات استهداف')
@section('navigation1_link','/admin/home')
@section('navigation3_link','/admin/target_types')
                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-4 col-md-6 col-sm-12">
                            <div class="form-group">
                                <label class="col-form-label col-lg-12">بحث من خلال اسم الفئة استهداف</label>
                                <div style="width: 95%;">
                ...
                <div class="table-responsive">
                    ...
                    <table class="table table-bordered table-hover ">
                        ...
                        <tr class="text-center">
                            ...
                            <th style="width: 20%;">اسم الفئة استهداف
                            </th>
                            ...
                            <span
                                ...
                                <label>
                                    <input class="cbActive" type="checkbox"
                                           ...
                                           title="لا تملك صلاحية اعتماد فئة استهداف"
                                           value="{{$item->id}}"
                            @endif>
                                    <span></span>
                                </label>
                                ...
                                <td>
                                    ...
                                    <div class="dropdown dropdown-inline">
                                        ...
                                        <div class="dropdown-menu dropdown-menu-right">
                                            <a class="dropdown-item" href="/admin/target_types/{{$item->id}}/edit"><i
                                                        class="fa fa-pen"></i>
                                                تعديل
                                            </a>
                                            <a class="dropdown-item"
                                               href="/admin/institutions?target_types_ids[]={{$item->id}}"><i
                                                        class="fa fa-pen"></i>
                                                الجمعيات
                                            </a>
                                            <a class="dropdown-item Confirm"
                                               href="/admin/target_types/delete/{{$item->id}}">
    ...
    <script>
        $(function () {
            $(".cbActive").change(function () {
                ...
                $.ajax({
                    url: "/admin/target_types/approve/" + id,
