...
@section('pageTitle','إدارة أوضاع الأثاث')
@section('headerCSS')
...
@section('navigation3','إدارة أوضاع الأثاث')
@section('navigation1_link','/admin/home')
@section('navigation3_link','/admin/furnitureStatuses')
            ...
            <div class="kt-portlet__body">
                ...
                <table class="table table-bordered table-hover" id="table">
                    ...
                    <tr class="text-center">
                        <th class="big-col">#</th>
                        <th class="big-col"> وضع الأثاث بالعربي</th>
                        <th width="15%">العمليات</th>
                    </tr>
                    </thead>
                    <tbody>
                    @php $i = 1 @endphp
                    @foreach($furnitureStatuses->sortByDesc('created_at') as $furnitureStatus)
                        <tr>
                            <td width="10%"> {{ $i }} </td>
                            <td> {{ $furnitureStatus->name }} </td>
                            <td>
                                <div class="dropdown dropdown-inline">
                                    ...
                                    <div class="dropdown-menu dropdown-menu-right">
                                        <a class="dropdown-item Confirm"
                                           href="{{ url('admin/furnitureStatuses/delete/'.$furnitureStatus->id) }}"><i
                                                    class="fa fa-trash"></i>حذف</a>
                                        <a class="dropdown-item"
                                           href="{{ url('admin/furnitureStatuses/'.$furnitureStatus->id .'/edit') }}"><i
